...
export const HomePage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-muted to-background overflow-hidden">
      {/* Hero Section */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="mb-8 fade-in">
            <div className="inline-flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-gradient-primary rounded-3xl flex items-center justify-center text-white font-bold text-3xl shadow-2xl bg-slate-950">
                B
              </div>
              <h1 className="text-6xl font-bold bg-gradient-primary bg-clip-text text-gray-950">
                Bizzly
              </h1>
            </div>
          ...
          <div className="mb-12 slide-up">
            <h2 className="text-5xl md:text-7xl mb-6 leading-tight font-bold text-slate-950 py-0">
              Управляйте бизнесом
              <br />
              <span className="bg-gradient-secondary bg-clip-text text-slate-950">
                эффективно
              </span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 px-0 py-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 scale-in">
            <Button onClick={() => navigate('/auth')} className="material-button px-8 py-4 h-auto text-lg">
              Начать бесплатно
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            <Button variant="outline" className="text-lg px-8 py-4 h-auto border-2 hover:shadow-glow">
              Демо-версия
            </Button>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            return <div key={feature.title} className="floating-card p-6 rounded-3xl text-center group" style={{
              animationDelay: `${index * 200}ms`
            }}>
                  <div className="w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:shadow-glow transition-all duration-300 bg-stone-950">
                    <Icon className="w-8 h-8 text-white bg-black" />
                  </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-primary/5 to-secondary/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button onClick={() => navigate('/auth')} className="material-button text-lg px-8 py-4 h-auto">
